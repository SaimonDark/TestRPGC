...
Module Program
  ...
  Public Sub TextunderMap(ByVal _x As Integer, ByVal _y As Integer)
    While _menuVibor(1) <> "5"
      ...
      Select Case _menuVibor(1)
        Case 1
          While _menuVibor(2) <> "6"
            Console.WriteLine(" Вы выбрали 'Земля'                                   ")
            Console.WriteLine("           ___________________________________________")
            Console.Write("          ║ 1. Болота         ")
            ...
            Select Case _menuVibor(2)
              ...
              Case 3
                ...
                _menuVibor(1) = "5"
              Case 4
                While _menuVibor(6) <> "4"
                  Console.WriteLine(" Вы выбрали 'Дороги'                                  ")
                  Console.WriteLine("           ___________________________________________")
                  Console.Write("          ║ 1. Обычная        ")
                  _txtRGB.TxtRGB("DarkYellow", "DarkGray", "▓", False) 'Дорога 4
                  Console.WriteLine("                                                                 ")
                  Console.Write("          │ 2. Каменная       ")
                  _txtRGB.TxtRGB("DarkYellow", "Black", "▓", False) 'Дорога 5
                  Console.WriteLine("                                                                 ")
                  Console.Write("          │ 3. Затоптанная    ")
                  _txtRGB.TxtRGB("Yellow", "DarkGreen", "░", False) 'Дорога 6
                  Console.WriteLine("                                                                 ")
              ...
              Case 5
                While _menuVibor(7) <> "6"
                  ...
                  _txtRGB.TxtRGB("White", "DarkGray", "░", False) 'Снег 7
                  Console.Write("   5. Затвердевшая лава  ")
                  _txtRGB.TxtRGB("Red", "Black", "░", False) 'Затвердевшая лава 11
                  Console.WriteLine("                                                                 ")
                  Console.Write("          │ 2. Лёд          ")
                  _txtRGB.TxtRGB("Cyan", "Blue", "▓", False) 'Тонкий лёд 8
                  Console.WriteLine("  6. Выход                      ")
                  Console.Write("          │ 3. Тонкий лёд   ")
                  _txtRGB.TxtRGB("Cyan", "DarkBlue", "▒", False) 'Тонкий лёд 9
                  Console.WriteLine("                                                                 ")
                  Console.Write("          │ 4. Лава         ")
                  _txtRGB.TxtRGB("DarkRed", "DarkYellow", "▓", False) 'Лава 10
                  Console.WriteLine("                                                                 ")
                  Console.WriteLine("          └                                           ")
        ...
        Case 2
          While _menuVibor(3) <> "4"
            ...
            _txtRGB.TxtRGB("Cyan", "DarkGreen", "░", False) 'Лес 12
            Console.WriteLine("                                                                 ")
            Console.Write("          │ 2. Эльфийские    ")
            _txtRGB.TxtRGB("Black", "DarkGreen", "░", False) 'Эльфийский Лес 13
            Console.WriteLine("                                                               ")
            Console.Write("          │ 3. Заражённые    ")
            _txtRGB.TxtRGB("DarkMagenta", "Black", "░", False) 'Заражённый лес 14
            Console.WriteLine("                                                                  ")
            Console.WriteLine("          │ 4. Выход                                  ")
            Console.WriteLine("          └                                           ")
          ...
          _menuVibor(3) = "0"
        Case 3
          While _menuVibor(4) <> "4"
            Console.WriteLine(" Вы выбрали 'Реки'                                   ")
            Console.WriteLine("           ___________________________________________")
            Console.Write("          ║ 1. Водная местность  ")
            _txtRGB.TxtRGB("Blue", "Black", "░", False) 'Водная местность 15
            Console.WriteLine("                                                                  ")
            Console.Write("          │ 2. Мелководье        ")
            _txtRGB.TxtRGB("White", "DarkBlue", "░", False) 'Водная местность 16
            Console.WriteLine("                                                                  ")
            Console.Write("          │ 3. Берег             ")
            _txtRGB.TxtRGB("White", "Cyan", "░", False)  'Речная местность 17
            Console.WriteLine("                                                                  ")
            Console.WriteLine("          │ 4. Выход                                  ")
            Console.WriteLine("          └                                           ")
          ...
          _menuVibor(4) = "0"
        Case 4
          While _menuVibor(5) <> "4"
            Console.WriteLine(" Вы выбрали 'Города'                                  ")
              Console.WriteLine("           ___________________________________________")
              Console.Write("          ║ 1. Заброшенные  ")
            _txtRGB.TxtRGB("DarkMagenta", "Black", "░", False) '18
            Console.WriteLine("                                                                  ")
              Console.Write("          │ 2. Действующие  ")
            _txtRGB.TxtRGB("Black", "DarkBlue", "░", False) '19
            Console.WriteLine("                                                                  ")
              Console.Write("          │ 3. Руины        ")
            _txtRGB.TxtRGB("Red", "Black", "░", False) '20
            Console.WriteLine("                                                                  ")
              Console.WriteLine("          │ 4. Выход                                  ")
              Console.WriteLine("          └                                           ")
  ...
  Public Sub ColorSquear(ByVal _toolQ As Integer)
    ...
    If _toolQ = 4 Then _txtRGB.TxtRGB("DarkYellow", "DarkGray", "▓", False) 'Дорога обычная 4
    If _toolQ = 5 Then _txtRGB.TxtRGB("DarkYellow", "Black", "▓", False) 'Дорога каменная 5
    If _toolQ = 6 Then _txtRGB.TxtRGB("Yellow", "DarkGreen", "░", False) 'Дорога затоптанная 6
    If _toolQ = 7 Then _txtRGB.TxtRGB("White", "DarkGray", "░", False) 'Снег 7
    If _toolQ = 8 Then _txtRGB.TxtRGB("Cyan", "Blue", "▓", False) 'лёд 8
    If _toolQ = 9 Then _txtRGB.TxtRGB("Cyan", "DarkBlue", "▒", False) 'Тонкий лёд 9
    If _toolQ = 10 Then _txtRGB.TxtRGB("DarkRed", "DarkYellow", "▓", False) 'Лава 10
    If _toolQ = 11 Then _txtRGB.TxtRGB("Red", "Black", "░", False) 'Затвердевшая лава 11
    If _toolQ = 12 Then _txtRGB.TxtRGB("Cyan", "DarkGreen", "░", False) 'Лес 12
    If _toolQ = 13 Then _txtRGB.TxtRGB("Black", "DarkGreen", "░", False) 'Эльфийский Лес 13
    If _toolQ = 14 Then _txtRGB.TxtRGB("DarkMagenta", "Black", "░", False) 'Заражённый лес 14
    If _toolQ = 15 Then _txtRGB.TxtRGB("Blue", "Black", "░", False) 'Водная местность 15
    If _toolQ = 16 Then _txtRGB.TxtRGB("White", "DarkBlue", "▓", False) 'Мелководье 16
    If _toolQ = 17 Then _txtRGB.TxtRGB("White", "Cyan", "░", False)  'Берег 17
    If _toolQ = 18 Then _txtRGB.TxtRGB("DarkMagenta", "Black", "░", False) 'Заброшенный город 18
    If _toolQ = 19 Then _txtRGB.TxtRGB("Black", "DarkBlue", "░", False) 'Действующий город 19
    If _toolQ = 20 Then _txtRGB.TxtRGB("Red", "Black", "░", False) 'Руины 20
  End Sub
  ...
  Public Sub SaveData() ' корректная запись массивов в файл
    Try
      ...
      Try
        For i = 0 To 16
          For j = 0 To 50
            myFileWriter.WriteLine(_mapTest(i, j))
