Public Class Hero
  ...
  Public Sub InfoHero()
    ...
    _System.TxtRGB("Red", "Black", "  __________________________________________________________", True)
    _System.TxtRGB("White", "Black", "  ║  Сила:        " & _h._strength & If(_dopperks(1) > 0, " +(" & _dopperks(1) & ")", vbTab) & vbTab & _h._strength_Class & vbTab & _h._strength_race & vbTab & _strength_Equip, True)
    _System.TxtRGB("White", "Black", "  ║  Интеллект:   " & _h._intelligece & If(_dopperks(2) > 0, " +(" & _dopperks(2) & ")", vbTab) & vbTab & _h._intelligece_Class & vbTab & _h._intelligece_race & vbTab & _intelligece_Equip, True)
    _System.TxtRGB("White", "Black", "  ║  Защита:      " & _h._defense & If(_dopperks(3) > 0, " +(" & _dopperks(3) & ")", vbTab) & vbTab & _h._defense_Class & vbTab & _h._defense_race & vbTab & _defense_Equip, True)
    _System.TxtRGB("White", "Black", "  ║  Ловкость:    " & _h._agility & If(_dopperks(4) > 0, " +(" & _dopperks(4) & ")", vbTab) & vbTab & _h._agility_Class & vbTab & _h._agility_race & vbTab & _agility_Equip, True)
    _System.TxtRGB("White", "Black", "  ║  Точность:    " & _h._accuracy & If(_dopperks(5) > 0, " +(" & _dopperks(5) & ")", vbTab) & vbTab & _h._accuracy_Class & vbTab & _h._accuracy_race & vbTab & _accuracy_Equip, True)
    _System.TxtRGB("Red", "Black", "  ╓─────────────────────────────────────────────────────────", True)
