...
Module Main
  ...
  Sub Main()
    ...
    While _vibor(0) <> 4
      ...
      _System.TxtRGB("White", "Black", "                     3. Авторы.", True)
      _System.TxtRGB("White", "Black", "                     4. Выход.", True)
      ...
      Select Case _vibor(2)
        Case 1
          ...
          If chance_crit <= _hero._h._accuracy Then 'критический удар
            ...
            Console.Write("   [" & _enemy._enemyGame(_location, fRand)._enemyLiveMax & "]")
            _hero.Exxeption(_enemy._enemyGame(_location, fRand)._enemylive, _enemy._enemyGame(_location, fRand)._enemyLiveMax, _enemy._enemyGame(_location, fRand)._colorLive)
            Console.WriteLine("[" & _enemy._enemyGame(_location, fRand)._enemylive & "] критический удар -" & _hero._skl(0)._crit & If(_hero._PerksStatLvl(0) > 0, " +" & _hero._PerksStatLvl(0) * 1.5 & " ", " "))
            Console.WriteLine("    ╞════════════════▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
            Console.Write("    │ " & _hero._h._name & vbTab & "   [" & _hero._h._liveMax & "]")
            _hero.Exxeption(_hero._h._live, _hero._h._liveMax, "Red")
        ...
        Case 2
          If _hero._skils(2) > 0 And _hero._h._mana >= 3 Then
            ...
            If chance_crit <= _hero._h._accuracy Then 'критический удар
              ...
              Console.Write("   [" & _enemy._enemyGame(_location, fRand)._enemyLiveMax & "]")
              _hero.Exxeption(_enemy._enemyGame(_location, fRand)._enemylive, _enemy._enemyGame(_location, fRand)._enemyLiveMax, _enemy._enemyGame(_location, fRand)._colorLive)
              Console.WriteLine("[" & _enemy._enemyGame(_location, fRand)._enemylive & "] критический удар -" & _hero._skl(1)._crit & If(_hero._PerksStatLvl(1) > 0, " +" & _hero._PerksStatLvl(1) * 1.5 & " ", " "))
              Console.WriteLine("    ╞════════════════▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
              Console.Write("    │ " & _hero._h._name & vbTab & "   [" & _hero._h._liveMax & "]")
              _hero.Exxeption(_hero._h._live, _hero._h._liveMax, "Red")
              Console.WriteLine("[" & _hero._h._live & "] -" & _vivodundmg & "                        ")
        ...
        Case 3
          If _hero._skils(3) > 0 And skill3 >= 3 And _hero._h._mana >= 5 Then
            ...
            If chance_crit <= _hero._h._accuracy Then 'критический удар
              ...
              Console.Write("   [" & _enemy._enemyGame(_location, fRand)._enemyLiveMax & "]")
              _hero.Exxeption(_enemy._enemyGame(_location, fRand)._enemylive, _enemy._enemyGame(_location, fRand)._enemyLiveMax, _enemy._enemyGame(_location, fRand)._colorLive)
              Console.WriteLine("[" & _enemy._enemyGame(_location, fRand)._enemylive & "] критический удар -" & _hero._skl(2)._crit & If(_hero._PerksStatLvl(2) > 0, " +" & _hero._PerksStatLvl(2) * 1.5 & " ", " "))
              Console.WriteLine("    ╞════════════════▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
              Console.Write("    │ " & _hero._h._name & vbTab & "   [" & _hero._h._liveMax & "]")
              _hero.Exxeption(_hero._h._live, _hero._h._liveMax, "Red")
              Console.WriteLine("[" & _hero._h._live & "] -" & _vivodundmg & "                        ")
        ...
        Case 4
          If _hero._skils(4) > 0 And skill4 >= 2 And _hero._h._mana > _hero._h._manaMax * 0.6 Then
            ...
            If chance_crit <= _hero._h._accuracy Then 'критический удар
              ...
              Console.Write("   [" & _enemy._enemyGame(_location, fRand)._enemyLiveMax & "]")
              _hero.Exxeption(_enemy._enemyGame(_location, fRand)._enemylive, _enemy._enemyGame(_location, fRand)._enemyLiveMax, _enemy._enemyGame(_location, fRand)._colorLive)
              Console.WriteLine("[" & _enemy._enemyGame(_location, fRand)._enemylive & "] критический удар -" & _hero._skl(3)._crit & If(_hero._PerksStatLvl(3) > 0, " +" & _hero._PerksStatLvl(3) * 1.5 & " ", " "))
              Console.WriteLine("    ╞════════════════▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬")
              Console.Write("    │ " & _hero._h._name & vbTab & "   [" & _hero._h._liveMax & "]")
              _hero.Exxeption(_hero._h._live, _hero._h._liveMax, "Red")
              Console.WriteLine("[" & _hero._h._live & "] -" & _vivodundmg & "                        ")
